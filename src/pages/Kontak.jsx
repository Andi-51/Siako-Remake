      ...
      <div className="flex-1 mx-auto w-full max-w-6xl px-4 py-10">
        <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
          <div className="flex-1 flex flex-col items-center text-center bg-gray-200 p-6 rounded-2xl shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-black pt-5">
              (0266) 734-796
            </h3>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center text-center bg-gray-200 p-6 rounded-2xl shadow-lg px-2">
        ...
        <div className="mt-10 h-[400px] w-full rounded-2xl overflow-hidden shadow-lg border">
          <MapContainer
            center={position}
            zoom={16}
